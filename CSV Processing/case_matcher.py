...
def map_values(df):
	...
	f = open("C:/Users/chris/Documents/GitHub/State-Sentencing-Project/CSV Processing/edited_codes.csv")
	for line in f:
		line = line.strip('\n')
...
for court in court_list["Court ID"]:
	data = pd.read_csv(f"C:/Users/chris/Documents/case data/finished courts/{court}.csv")
...
final_cases.to_csv("C:/Users/chris/Documents/case data/finished courts/final.csv")

print(final_cases["Judge Full Name"].isna().mean()) #0.3043542749138131

# This means that we were able to match judges for 70% of the cases, which is great! 
#We could improve this accuracy by looking into the inconsistencies in how some courts record their judges' initials.
